    ...
    return (
        <div className="w-full animate-fade-in z-20">
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-shetra-text-muted text-sm mt-2">Sign in to stay connected and protected.</p>
            </div>
            ...
            <div className="bg-shetra-surface/50 backdrop-blur-xl border border-shetra-border/50 rounded-2xl p-6 sm:p-8 shadow-2xl">
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <Button type="submit" fullWidth size="lg" disabled={loading} className="mt-2 shadow-[0_0_15px_rgba(255,46,99,0.3)]">
                ...
                {/* Google Login */}
                <Button variant="secondary" fullWidth size="lg" onClick={handleGoogleLogin} className="hover:bg-white/5 border border-white/10">
                ...
                <p className="mt-8 text-center text-sm font-body text-shetra-text-muted group">
                    ...
                    <Link href="/auth/register" className="text-shetra-light font-medium group-hover:text-shetra-neon transition-colors duration-300 relative inline-block">
                        Register now
